function [center, width] = fwhmc(x,y)
...
if centerindex<10   ; center= x(centerindex); width = NaN; return ;end
if centerindex>N-10 ; center= x(centerindex); width = NaN; return ;end
i = 2;
